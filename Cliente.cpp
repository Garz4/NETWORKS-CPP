		...
		while(getline(archivoLeer,linea)){
			...
			if(archivoEnviar.is_open()){
				...
				if(tamArchivo > LIMITE_ARCHIVO){
					cout << "==================================" << endl;
					cout << "--!! ADVERTENCIA: " << nombreLeer << " pesa " << mensajeEnvio.tam << " bytes y sobrepasa el límite de " << LIMITE_ARCHIVO << " bytes." << endl;
				...
				cout << "==================================" << endl;
				cout << "--!! ADVERTENCIA: " << nombreLeer << " es un archivo inexistente." << endl;
				cout << "El archivo será omitido." << endl;
			}
			delete[] nombreLeer;
		}
